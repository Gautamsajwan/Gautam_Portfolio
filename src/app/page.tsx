...
export default function Page() {
  return (
    <main className="flex flex-col min-h-[100dvh] space-y-10">
          ...
          <div className="flex justify-between gap-2">
            <div className="flex flex-col flex-1 space-y-1.5">
              <BlurFadeText
                ...
                className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl pt-4"
                yOffset={8}
                text={`Hiii, I'm ${DATA?.name?.split(" ")[0]}`}
              />
              <BlurFadeText
      ...
      {/* Contact Section */}
      <section id="contact">
        <div className="flex flex-col items-center gap-4 px-4 text-center w-full py-12">
